#!/usr/bin/env python3
"""
Test database connectivity and configuration (complete fix)
"""
...
def test_database_connectivity():
    ...
    try:
        ...
        # Test 10: Trigger System Performance (with all required columns)
        print("\n⚡ Test 10: Trigger System Performance")
        ...
        cursor.execute("""
            INSERT INTO congress_bills (
                ...
                introduced_date, origin_chamber, current_chamber
            ) VALUES (
                'test_connectivity', 118, 'hr', '9999',
                'Database Connectivity Test Bill', 
                '2024-01-01', 'House', 'House'
            )
        """)
        conn.commit()
