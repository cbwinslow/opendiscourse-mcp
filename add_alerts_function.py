#!/usr/bin/env python3
"""
Add missing get_ingestion_alerts function
"""

import os
import psycopg2

def add_alerts_function():
    """Add the missing get_ingestion_alerts function"""
    db_url = os.getenv('DATABASE_URL')
    conn = psycopg2.connect(db_url)
    cursor = conn.cursor()
    
    print("🔧 Adding get_ingestion_alerts function...")
    ...
    conn.commit()
    print("✅ get_ingestion_alerts function added successfully!")
