#!/bin/bash
# Congress 118 Data Ingestion Script
# Generated on Wed Nov 12 05:18:54 PM EST 2025

set -e

echo "🏛️  Starting Congress 118 Data Ingestion - $(date)"
echo "======================================================"
...
# Log file
LOG_FILE="/home/cbwinslow/opendiscourse/logs/congress_118_ingestion_$(date +%Y%m%d_%H%M%S).log"
exec > >(tee -a "$LOG_FILE") 2>&1

echo "📊 Processing Congress 118 data..."
...
echo "✅ Congress 118 ingestion completed - $(date)"
